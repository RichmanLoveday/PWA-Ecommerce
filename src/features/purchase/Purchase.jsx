  ...
  return (
    <>
      <Container>
        <Row className="p-2">
          <Col
            className="shadow-sm bg-white mt-2 p-4"
            md={12}
            lg={12}
            sm={12}
            xs={12}
          >
            ...
            <p className="section-title-contact">
              ...
              remember are believed yet say finished. Or neglected agreeable of
              discovery concluded oh it sportsman.
              <br />
              <br />
              ...
              wanted indeed wished out law. Far advanced settling say finished
              raillery. Offered chiefly farther of my no colonel shyness. Such
              on help ye some door if in. Laughter proposal laughing any son law
              consider. Needed except up piqued an. So by colonel hearted
              ferrars. Draw from upon here gone add one. He in sportsman
              household otherwise it perceived instantly.
              <br />
              <br />
              ...
              did she. In entirely be to at settling felicity. Fruit two match
              men you seven share. Needed as or is enough points.
              <br />
              <br />
              Miles at smart ﻿no marry whole linen mr. Income joy nor can wisdom
              summer. Extremely depending he gentleman improving intention
              rapturous as.
            </p>
          </Col>
        </Row>
